...
<div class="container my-forum-container">
    ...
    <div class="user">
        <?php
        if($_SESSION['id']){
            $user = mysqli_query($connection, "SELECT * FROM users WHERE id='".$_SESSION['id']."'");
    ...
    <button type="button" class="btn btn-dark btn-lg btn-block">Редактировать профиль</button>
</div>
